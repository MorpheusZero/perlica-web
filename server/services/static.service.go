...
func (ss *StaticService) ServeStaticFile(w http.ResponseWriter, r *http.Request, filePath string) error {
	...
	if strings.Contains(cleanPath, "..") {
		fmt.Println("Invalid file path detected: " + cleanPath)
	...
	if err != nil {
		fmt.Println("Static file not found: " + cleanPath + " - " + err.Error())
	...
	if err != nil {
		fmt.Println("Failed to write static file content: " + cleanPath + " - " + err.Error())
		return err
	}

	fmt.Println("Served static file: " + cleanPath)
	return nil
}
